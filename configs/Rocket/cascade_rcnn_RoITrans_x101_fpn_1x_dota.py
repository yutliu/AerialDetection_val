# model settings
model = dict(
    type='RoITran_Cascade',
    num_stages=3,
    pretrained="https://download.openmmlab.com/pretrain/third_party/resnext101_32x4d-a5af3160.pth",
    backbone=dict(
        type='ResNeXt',
        depth=101,
        groups=32,
...
data_root = '/media/adminer/data/Rocketforce/SummaryData_mmdet/'
...
log_level = 'INFO'
work_dir = './work_dirs/cascade_rcnn_RoITrans_x101_fpn_1x_dota'
load_from = None
resume_from = None
workflow = [('train', 1)]
